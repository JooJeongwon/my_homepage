---
title: "Clean Architecture 기반의 기술 블로그 작성하기"
date: "2026.01"
description: "Next.js 16 App Router 환경에 Hexagonal Architecture(Ports and Adapters)를 도입하여, 비즈니스 로직과 UI/데이터 소스를 완벽하게 분리한 확장 가능한 웹 플랫폼"
