...
export class ProjectMdxRepository implements ProjectRepository {
    ...
    async getAllProjects(): Promise<Project[]> {
        try {
            ...
            const projects = files
                ...
                .map((file) => {
                    try {
                        ...
                        console.error(`[ProjectMdxRepository] Error parsing project ${file}:`, error);
                        return null;
                    }
                })
            ...
            console.error('[ProjectMdxRepository] Error reading projects directory:', error);
            return [];
        }
    }
    ...
    async getProjectBySlug(slug: string): Promise<Project | null> {
        try {
            ...
            console.error(`[ProjectMdxRepository] Error parsing project ${slug}:`, error);
            return null;
        }
    }
}
